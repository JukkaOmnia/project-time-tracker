...
class Customer extends Component {
    ...
    getAllCustomer() {
        Meteor.call('customers.getAll');
    }

    insertCustomer() {
        Meteor.call('customers.insert', this.state.name);
    }

    updateCustomer() {
        Meteor.call('customers.update', this.props.customer._id, this.state.name);
    }
    ...
    onSave = () => {
        ...
        this.insertCustomer(this.state.name);
    };
